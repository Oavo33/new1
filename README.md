...
<div class="grid-container">
  ...
  <div class="grid-item" style="background-image: url('https://i.imgur.com/gT1Sbd4.png'); background-repeat: no-repeat; background-position: center; transform: scale(0.8);" onclick="changeColor(this)">
  <p class="-text" onclick="window.location.href='1'">New Button 1</p>
  <p class="-text" onclick="window.location.href='URL_HERE'">New Button 6</p>
</div>
