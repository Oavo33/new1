...
<div class="grid-container">
  ...
  <div class="grid-item" style="background-image: url('https://i.imgur.com/gT1Sbd4.png'); background-size: 110% ; background-repeat: no-repeat; background-position: center;" >
